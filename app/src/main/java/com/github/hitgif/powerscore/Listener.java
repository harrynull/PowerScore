    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.image_iat_set:
                Intent intents = new Intent(Listener.this, IatSettings.class);
            ...
            case R.id.iat_recognize_stream:
                ...
                if (ret != ErrorCode.SUCCESS) {
                    ...
                    byte[] audioData = FucUtil.readAudioFile(Listener.this, "iattest.wav");
            ...
            case R.id.iat_upload_contacts:
                ...
                ContactManager mgr = ContactManager.createManager(Listener.this,
                        mContactListener);
