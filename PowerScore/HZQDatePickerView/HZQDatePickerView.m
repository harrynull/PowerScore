...
- (void)awakeFromNib
{
    ...
    [self.sureBtn setTitleColor:[UIColor colorwithHexString:@"0072A9"] forState:0];
    self.sureBtn.layer.borderColor = [[UIColor colorwithHexString:@"0072A9"] CGColor];
    self.sureBtn.layer.masksToBounds = YES;
    
    /** 不限 */
    self.cannelBtn.layer.cornerRadius = 4;
    self.cannelBtn.layer.borderWidth = 1;
    [self.cannelBtn setTitleColor:[UIColor colorwithHexString:@"0072A9"] forState:0];
    self.cannelBtn.layer.borderColor = [[UIColor colorwithHexString:@"0072A9"] CGColor];
